        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_AspNetUsers_ParentUserId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "90a9a120-23ce-49a1-97f4-533485ab74ed", "Administrator", "ADMINISTRATOR" },
                    { "2", "8cf821b6-2986-4a4a-975c-b5234d957c14", "Instructor", "INSTRUCTOR" },
                    { "3", "0ec95cf7-a6a0-4729-8f1f-be16d3d29dce", "Student", "STUDENT" },
                    { "4", "f989b4ea-1d6c-4b9a-a493-99f03679b3ab", "Parent", "PARENT" }
                });

            migrationBuilder.InsertData(
                table: "ClassTypes",
                columns: new[] { "Id", "Color", "CreatedAt", "Description", "IsActive", "Name", "TargetAgeGroup" },
                values: new object[] { 1, "#FF6B6B", new DateTime(2026, 2, 16, 22, 4, 8, 900, DateTimeKind.Utc).AddTicks(8171), "Creative painting classes for all skill levels", true, "Painting", 7 });
